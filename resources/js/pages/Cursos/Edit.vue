...
const form = useForm({
    ...
    dias_semana: props.curso.dias_semana || [],
    periodo: props.curso.periodo,
    max_alunos: props.curso.max_alunos,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-full p-4 md:p-6">
            <div class="mb-6 flex items-center gap-3">
                ...
                <h1 class="text-2xl font-bold text-foreground">Editar Curso</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="rounded-xl border border-border bg-card p-6 shadow-sm">
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="mb-1 block text-sm font-medium">Máx. alunos *</label>
