...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Novo Usuário', href: '/usuarios/create' },
];
        ...
        <div class="mx-auto max-w-3xl p-4 md:p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-foreground">Novo Usuário</h1>
                        <p class="text-sm text-muted-foreground">Preencha os dados de acesso e permissões iniciais.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-border bg-card shadow-sm">
                <form @submit.prevent="submit" class="flex flex-col gap-6 p-6">
                    <div class="grid gap-6 sm:grid-cols-2">
                        ...
                        <!-- Email -->
                        <div class="sm:col-span-2">
                            <label class="mb-1 block text-sm font-medium">Email * (Será o login de acesso)</label>
                            <input
                                v-model="form.email"
                                type="email"
                                class="h-10 w-full rounded-lg border border-input bg-background px-3 text-sm outline-none transition-colors focus:border-primary"
                        ...
                        <!-- Senha -->
                        <div>
                            <label class="mb-1 block text-sm font-medium">Senha Provisória *</label>
                            <input
                            ...
                            <p class="mt-1 text-xs text-muted-foreground">Mínimo de 8 caracteres.</p>
                        </div>
