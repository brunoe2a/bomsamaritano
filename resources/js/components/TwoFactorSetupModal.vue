...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação de dois fatores agora está habilitada. Escaneie o código QR ou insira a chave de configuração no seu aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description: 'Insira o código de 6 dígitos gerado pelo seu aplicativo autenticador.',
    ...
    return {
        ...
        description:
            'Para finalizar a ativação da autenticação de 2 fatores, escaneie o código QR ou insira a chave de configuração no seu aplicativo.',
        buttonText: 'Continuar',
    };
});
